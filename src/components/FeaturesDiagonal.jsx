...
export const FeaturesDiagonal = () => {
  ...
  <p className="mb-16 text-customGrayText leading-loose">
    At Alowes Marketing Solutions, we're not just about launching campaigns—we're about launching success stories. Our intuitive platform marries data with creativity, ensuring your marketing not only reaches but resonates with your audience. Turn insights into influence and clicks into customers.
  </p>
  <button
